...
\begin{document}
    ...
    \section{Objetivo:}
    Desarrollar filtros pasa bajas y pasa altas utilizando la raspberry pi pico 2w, para así comprender el proceso de diseño, implementación y análisis de filtros digitales en un microcontrolador.
