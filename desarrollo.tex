...
% ============================================================
\newpage
\subsection{Diseño del Filtro Pasa Altas de Primer Orden (Circuito RC)}
% ============================================================
...
El filtro pasa altas de primer orden se implementa con un circuito \textbf{RC serie}, tomando la salida sobre la resistencia.
...
\begin{figure}[H]
    ...
    \begin{circuitikz}[american, scale=1.0]
        ...
        \node[right] at (5.5,0) {$-$};
    \end{circuitikz}
    \caption{Circuito RC pasa altas de primer orden (salida sobre $R$).}
...
\begin{table}[H]
    \centering
    \caption{Coeficientes del filtro pasa altas de primer orden ($f_c = 500$ Hz, $f_s = 8000$ Hz).}
    \label{tab:hp_coeff}
    \begin{tabular}{|c|c|c|}
        \hline
        \rowcolor{headblue}\textcolor{white}{\textbf{Coeficiente}} & \textcolor{white}{\textbf{Expresión}} & \textcolor{white}{\textbf{Valor numérico}} \\
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[
        ...
        \draw[->] (B1) -- (S);
    \end{tikzpicture}
    \caption{Diagrama de flujo de señal del filtro pasa altas de primer orden (Forma Directa I).}
